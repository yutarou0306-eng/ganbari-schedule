...
export const GRAND_MASTER_COMBOS = {
  dragon: {
    ...
    tiger: { name: "タイガードラゴン", img: "/gm-dragon-tiger.png" },
    fenrir: { name: "フロストドラゴン", img: "/gm-dragon-fenrir.png" },
    griffon: { name: "スカイドラゴン", img: "/gm-dragon-griffon.png" },
  },
  phoenix: {
    dragon: { name: "ドラゴンフェニックス", img: "/gm-phoenix-dragon.png" },
    phoenix: { name: "エンペラーフェニックス", img: "/gm-phoenix-phoenix.png" },
    tiger: { name: "タイガーフェニックス", img: "/gm-phoenix-tiger.png" },
    fenrir: { name: "フロストファイア・フェニックス", img: "/gm-phoenix-fenrir.png" },
    griffon: { name: "グリフォンフェニックス", img: "/gm-phoenix-griffon.png" },
  },
  tiger: {
    dragon: { name: "ドラゴンタイガー", img: "/gm-tiger-dragon.png" },
    phoenix: { name: "フレイムタイガー", img: "/gm-tiger-phoenix.png" },
    tiger: { name: "キングタイガー", img: "/gm-tiger-tiger.png" },
    fenrir: { name: "フェンリルタイガー", img: "/gm-tiger-fenrir.png" },
    griffon: { name: "ウィングタイガー", img: "/gm-tiger-griffon.png" },
  },
  fenrir: {
    dragon: { name: "ドラゴニック・フェンリル", img: "/gm-fenrir-dragon.png" },
    phoenix: { name: "ブレイズフェンリル", img: "/gm-fenrir-phoenix.png" },
    tiger: { name: "サンダーフェンリル", img: "/gm-fenrir-tiger.png" },
    fenrir: { name: "ロードフェンリル", img: "/gm-fenrir-fenrir.png" },
    griffon: { name: "ストームフェンリル", img: "/gm-fenrir-griffon.png" },
  },
  griffon: {
    dragon: { name: "ドラゴングリフォン", img: "/gm-griffon-dragon.png" },
    phoenix: { name: "ソーラーグリフォン", img: "/gm-griffon-phoenix.png" },
  ...
  pegasus: {
    pegasus: { name: "ロイヤルユニコーン", img: "/gm-pegasus-pegasus.png" },
    fairy: { name: "フェアリーユニコーン", img: "/gm-pegasus-fairy.png" },
    cat: { name: "ミスティックユニコーン", img: "/gm-pegasus-cat.png" },
    swamp: { name: "スワンユニコーン", img: "/gm-pegasus-swamp.png" },
